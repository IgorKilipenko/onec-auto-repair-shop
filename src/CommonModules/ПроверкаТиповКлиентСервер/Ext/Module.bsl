...
// Возвращаемое значение:
//  - Булево
Функция ЭтоФиксированныйМассив(Знач объект) Экспорт
    типОбъекта = ?(ТипЗнч(объект) = Тип("Тип"), объект, ТипЗнч(объект));
    Возврат типОбъекта = Тип("ФиксированныйМассив");
КонецФункции
...
// Возвращаемое значение:
//  - Булево
Функция ЭтоФиксированнаяСтруктура(Знач объект) Экспорт
    типОбъекта = ?(ТипЗнч(объект) = Тип("Тип"), объект, ТипЗнч(объект));
    Возврат типОбъекта = Тип("ФиксированнаяСтруктура");
КонецФункции
