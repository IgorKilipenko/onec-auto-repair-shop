...
//  ключ - Произвольный
//  поУмолчанию - Произвольный - Указанное значение будет возвращено если ключ отсутствует в структуре
//  вставитьКлюч - Булево - Если Истина то в случае отсутствия ключ будет вставлен в структуру (только для типа `объекта` - `Соответствие`)
// Возвращаемое значение:
//  - Произвольный, Неопределено
Функция ПолучитьЗначениеСоответствия(Знач объект, Знач ключ, Знач поУмолчанию = Неопределено, Знач вставитьКлюч = Ложь) Экспорт
