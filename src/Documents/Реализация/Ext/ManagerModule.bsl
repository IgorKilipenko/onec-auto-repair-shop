...
// Устарела. Используйте **ПолучитьТоварыДокумента** в сочетании с **ПолучитьОстаткиИСтатьиЗатратИзВТ**
// Получает выборку Товаров текущего документа, остатки по товарам на складе и статьи затрат
//  с итогами по Номенклатуре
// Параметры:
//  документСсылка - ДокументСсылка.Реализация
...
//      * КоличествоВДокументе - Число - Общее количество
...
Функция ПолучитьОстаткиИСтатьиЗатратИзВТ(Знач менеджер, Знач период, Знач склад, Знач выгрузить = Истина) Экспорт
    запрос = Новый Запрос;
