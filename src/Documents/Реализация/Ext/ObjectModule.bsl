...
Процедура выполнитьВсеДвиженияМатериаловЗаказчикаДокумента()
    ...
    материалыЗаказчикаДокумента = Документы.Реализация.ПолучитьМатериалыЗаказчикаДокумента(ЭтотОбъект.Ссылка, Истина);
    ДиагностикаКлиентСервер.Утверждение(материалыЗаказчикаДокумента <> Неопределено);

    Для Каждого строкаМатериалов Из материалыЗаказчикаДокумента Цикл
