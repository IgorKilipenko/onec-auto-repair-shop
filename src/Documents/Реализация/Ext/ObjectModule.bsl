...
Процедура выполнитьВсеДвиженияУслугДокумента()
    ...
    услугиДокумента.Свернуть("СтатьяЗатрат", "Сумма");
    статьиЗатратПоУслугамДокумента = услугиДокумента;
    Для каждого строкаСтатьиЗатрат Из статьиЗатратПоУслугамДокумента Цикл
        выполнитьДвижениеУчетЗатратОборот(строкаСтатьиЗатрат.СтатьяЗатрат, строкаУслуг.Сумма);
    КонецЦикла;
КонецПроцедуры
