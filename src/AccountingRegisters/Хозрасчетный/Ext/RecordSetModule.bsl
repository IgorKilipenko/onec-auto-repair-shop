...
//      * СодержаниеОперации - Строка, Неопределено - [Опциональное] Если аргумент `содержаниеОперации` = Неопределено то значение должно бвыть заполнено
//      * Сумма - Число
//  содержаниеОперации - Строка, Неопределено - Если Неопределено значение будет принято из `структураНачисления.СодержаниеОперации`
// Возвращаемое значение:
//  - РегистрБухгалтерииЗапись.Хозрасчетный - Заполненная запись
Функция ДобавитьЗаписьРасчетаСПерсоналом(Знач дата, Знач структураНачисления, содержаниеОперации = Неопределено) Экспорт
    новаяЗапись = ЭтотОбъект.Добавить();
    новаяЗапись.Период = дата;
    ...
    новаяЗапись.Содержание = ?(содержаниеОперации <> Неопределено, содержаниеОперации, структураНачисления.СодержаниеОперации);
