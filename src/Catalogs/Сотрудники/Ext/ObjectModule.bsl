...
Процедура ОбработкаПроверкиЗаполнения(отказ, проверяемыеРеквизиты)
    ...
    Если проверитьРеквизитИзСоставаФИО(реквизитыОбъекта.Фамилия.Имя, ЭтотОбъект.Фамилия) = Ложь Тогда
        отказ = Истина;
        исключитьПроверенныйРеквизит(реквизитыОбъекта.Фамилия.Имя, проверяемыеРеквизиты);
        Возврат;
    КонецЕсли;

    Если НЕ проверитьРеквизитИзСоставаФИО(реквизитыОбъекта.Имя.Имя, ЭтотОбъект.Имя) Тогда
        отказ = Истина;
        исключитьПроверенныйРеквизит(реквизитыОбъекта.Имя.Имя, проверяемыеРеквизиты);
        Возврат;
    КонецЕсли;
...
Процедура исключитьПроверенныйРеквизит(Знач имяРеквизита, Знач проверяемыеРеквизиты)
